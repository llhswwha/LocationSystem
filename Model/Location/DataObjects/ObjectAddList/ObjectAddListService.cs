...
namespace Location.Model.DataObjects.ObjectAddList
{
    public class ObjectAddListService
    {
        ...
        /// <returns></returns>
        public ObjectAddList GetObjectAddList(List<t_SetModel> modelList, List<t_Template_TypeProperty> typeList)
        {
            ...
            var ModelTypeList = from model in modelList
                                join type in typeList on (model.ID + "_前面板_0.png") equals type.FrontElevation into TempTable
        ...
        /// <param name="typeList"></param>
        /// <returns></returns>
        public ObjectAddList GetObjectAddListEx(List<t_SetModel> modelList, List<t_Template_TypeProperty> typeList)
        {
            var ModelTypeList = from model in modelList
                                join type in typeList on (model.ID + "_前面板_0.png") equals type.FrontElevation into TempTable
                                from c in TempTable.DefaultIfEmpty()
