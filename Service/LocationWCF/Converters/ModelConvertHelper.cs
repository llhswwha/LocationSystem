...
namespace LocationServices.Converters
{
    public static class ModelConvertHelper
    {
        ...
        {
            if (item1 == null) return null;
            var item2 = new Location.TModel.Location.Person.Personnel();
            item2.Id = item1.Id;
            item2.Abutment_Id = item1.Abutment_Id;
            item2.Name = item1.Name;
            ...
            item2.BirthTimeStamp = TimeConvert.TimeStampToDateTime(item1.BirthTimeStamp);
        ...
        {
            if (item1 == null) return null;
            var item2 = new DbModel.Location.Person.Personnel();
            item2.Id = item1.Id;
            item2.Abutment_Id = item1.Abutment_Id;
            item2.Name = item1.Name;
