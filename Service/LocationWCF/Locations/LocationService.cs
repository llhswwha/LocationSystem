...
namespace LocationServices.Locations
{
    ...
    public partial class LocationService : ILocationService, IDisposable
    {
        ...
        public ObjectAddList GetObjectAddList()
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetObjectAddList", "Exception:" + ex);
                return null;
            }
        }
        ...
        public KKSCode GetKKSInfoByNodeId(int id)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetKKSInfoByNodeId", "Exception:" + ex);
                return null;
            }
        }
        ...
        public KKSCode GetKKSInfoByCode(string code)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetKKSInfoByCode", "Exception:" + ex);
                return null;
            }
        }
        ...
        public KKSCode FindKKSInfoByName(string name)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "FindKKSInfoByName", "Exception:" + ex);
                return null;
            }
        }
        public string FindKKSCodeByName(string name)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "FindKKSCodeByName", "Exception:" + ex);
                return null;
            }
        }
        ...
        public string GetKKSCodeByNodeId(int id)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetKKSCodeByNodeId", "Exception:" + ex);
                return null;
            }
        }
        ...
        public bool AddConfigArg(ConfigArg config)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "AddConfigArg", "Exception:" + ex);
                return false;
            }
        }
        ...
        public bool EditConfigArg(ConfigArg config)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "EditConfigArg", "Exception:" + ex);
                return false;
            }
        }
        ...
        public bool DeleteConfigArg(ConfigArg config)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "DeleteConfigArg", "Exception:" + ex);
                return false;
            }
        }
        ...
        public ConfigArg GetConfigArg(int id)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetConfigArg", "Exception:" + ex);
                return null;
            }
        }
        ...
        public ConfigArg GetConfigArgByKey(string key)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetConfigArgByKey", "Exception:" + ex);
                return null;
            }
        }
        ...
        public List<ConfigArg> FindConfigArgListByKey(string key)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "FindConfigArgListByKey", "Exception:" + ex);
                return null;
            }
        }
        ...
        public List<ConfigArg> FindConfigArgListByClassify(string key)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "FindConfigArgListByClassify", "Exception:" + ex);
                return null;
            }
        }
        ...
        public TransferOfAxesConfig GetTransferOfAxesConfig()
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetTransferOfAxesConfig", "Exception:" + ex);
                return null;
            }
        }
        ...
        public bool SetTransferOfAxesConfig(TransferOfAxesConfig config)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "SetTransferOfAxesConfig", "Exception:" + ex);
                return false;
            }
        }
        ...
        public List<ConfigArg> GetConfigArgList()
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetConfigArgList", "Exception:" + ex);
                return null;
            }
        }
        ...
        public IList<Pos> GetHistoryPositonData(int nFlag, string strName, string strName2, string strName3)
        {
            ...
            {
                Log.Error(LogTags.DbGet, "GetHistoryPositonData", "Exception:" + ex);
                return null;
            }
        }
