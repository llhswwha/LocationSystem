...
namespace WebNSQLib.RecvMessage
{
    public class RecvFireAlarm : IHandler
    {
        ...
        public void HandleMessage(IMessage message)
        {
            ...
            if (recv == null || recv.node == null || recv.node == "" || recv.src != 3)
            {
                return;
            }

            DevInfo di = DevList.Find(p => p.Code == recv.node);
