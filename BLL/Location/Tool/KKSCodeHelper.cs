...
namespace Location.BLL.Tool
{
    ...
    string MainType, string SubType, string System) where T : IKKSCode, new()
        ...
        public static void TableToList(string strFolderName, DataTable dtTable, List<KKSCode> kksList, List<t_KKSCode> kksList2, KKSImportInfo<KKSCode> importInfo1, KKSImportInfo<t_KKSCode> importInfo2)
        {
            foreach (DataRow dr in dtTable.Rows)
            {
                ...
                var kks2 = CreateKKSCodeFromDataRow<t_KKSCode>(strFolderName, dr);//根据表格内容创建KKS对象
                ToKKSCodeList<t_KKSCode>(kks2, kksList2, importInfo2);
            }
        }
