...
namespace PlaybackDemo
{
    public partial class PlayBack : Form
    {
        ...
        private void UI_Init()
        {
            ...
            cboFileSaveFlag.SelectedIndex = 0;
        ...
        {          
            ...
            if (iRet < 0)
            {
                ...
                MessageBox.Show("Query file failed, ret=" + iRet);
                return;
            }
        ...
        private void btnPlayByFile_Click(object sender, EventArgs e)
        {
            ...
            if (iRet < 0)
            {
                MessageBox.Show("Play back by file failed，ret=" + iRet);
                return;
            }
        ...
        private void btnPlayByTime_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a correct channel number!");
                return;
            }
            ...
            if (iRet < 0)
            {
                MessageBox.Show("Play back by time failed!");
                return;
            }
        ...
        private void btnPlaySeek_Click(object sender, EventArgs e)
        {
            ...
            if (iPos <= 0 || iPos >= 100)
            {
                MessageBox.Show("Please input number between 1 and 99!");
                return;
            }
        ...
        private void timerPlayPos_Tick(object sender, EventArgs e)
        {
            ...
            else if (PLAY_TYEBY_TIME == m_iPlayType)
            {
                ...
                if (iAbsTime > 0)
                {
                    lablePlayProcess.Text = AbsSecondsToStr(iAbsTime);
                }                
            }
        }
        ...
        private void btnSnapShot_Click(object sender, EventArgs e)
        {
            ...
            if (iRet >= 0)
            {
                MessageBox.Show("Snap shot success! name=" + strFileName);
            }
            else
            {
                MessageBox.Show("Snap shot failed!");
            }
        } 
        ...
        private void btnDLFileStart_Click(object sender, EventArgs e)
        {
            ...
            if (m_iDLFileId > 0)
            {
                MessageBox.Show("It is downloading!");
                return;
            }
            ...
            Marshal.StructureToPtr(tInfo, intptr, true);
            int iRet = NVSSDK.NetClient_NetFileDownload(ref m_iDLFileId, m_iLogonId, NetSDKCmd.DOWNLOAD_CMD_FILE, intptr, tInfo.m_iSize);
            Marshal.FreeHGlobal(intptr);
            if (iRet < 0)
            {
        ...
        private void timerDLTimePos_Tick(object sender, EventArgs e)
        {
            ...
            {
                Int32 iPos = 0, iSize = 0;
                NVSSDK.NetClient_NetFileGetDownloadPos(m_iDLTimeId, ref iPos, ref iSize);
                ...
                if (iSetPos > 0 && iSetPos <= 100)
                {
                    ...
                    lbDownloadStatusTime.Text = AbsSecondsToStr(iPos);
                }                           
            }
        }
        ...
        private void btnDLTimeStart_Click(object sender, EventArgs e)
        {
            ...
            m_iDLStartTime = NvsFileTimeToAbsSeconds(tInfo.m_tTimeBegin);
            m_iDLStopTime = NvsFileTimeToAbsSeconds(tInfo.m_tTimeEnd);
